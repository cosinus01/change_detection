...
class FresUNet_edit(nn.Module):
    """FresUNet segmentation network."""

    def __init__(self, input_nbr, label_nbr, coeff_encode=2, base_depth=8):
        """Init FresUNet fields."""
        super(FresUNet_edit, self).__init__()
...
#         base_depth = 8
        ...
        self.decres4_1 = BasicBlock_ss(cur_depth)
        self.decres4_2 = BasicBlock_us(cur_depth, upsamp=2)
        cur_depth = int(cur_depth / coeff_encode)
